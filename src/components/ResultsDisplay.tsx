...
export function ResultsDisplay() {
  ...
  const isFinal = countdown.isExpired && configLoaded && votesLoaded;
  ...
  if (
    ...
    (accessState === "allowed" && (!configLoaded || !votesLoaded))
  ) {
    return (
    ...
    return (
      <main className="results-screen results-screen--centered">
        <section className="results-access-card">
          ...
          <Link
            to="/admin"
            className="festival-primary results-access-card__action"
          >
